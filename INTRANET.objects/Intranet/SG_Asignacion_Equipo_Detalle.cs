...
{
    public partial class SG_Asignacion_Equipo_Detalle
    {
        ...
        {
            this.id_AsignacionDetalle = (dataReader["id_AsignacionDetalle"] == DBNull.Value) ? 0 : Convert.ToInt32(dataReader["id_AsignacionDetalle"]);
